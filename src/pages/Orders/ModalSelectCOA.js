          ...
          content: [
                   ...
                   },
                    {
                        stack:[
                            ...
                            },
                            {
                                columns:[
                                    {
                                        text: '8/4 Samutjadee Rd. Paknum Muang Rayong 21000 Thailand', 
              ...
              },
            {
                table: {
                    ...
                    body: [
                        [
                            {text: `Date of Report : ${DateofReport}`, style: 'HeaderDetail',border: [true, true, false, false]}, //ซ้าย บน ขวา ล่าง
                            {text: `Lot : PROD:${Moment(values.PORD).format('DD/MM/YYYY')} \n ${".\t\tBBE:"+ Moment(values.BBE).format('DD/MM/YYYY')}`, style: 'HeaderDetail',border: [false, true, true, false]}
                        ],   
                        [
                            {text: `Order Number : ${"PO"+values.PO}`, style: 'HeaderDetail',border: [true, false, false, false]}, 
                            {text: `Deliverly Date : ${Moment(valueCustumer.DeliverlyDate).format('DD/MM/YYYY')}`, style: 'HeaderDetail',border: [false, false, true, false]}
                        ],  
                        [
                            {text: `Product Name : ${values.ProductName}`, style: 'HeaderDetail',border: [true, false, false, false]}, 
                            {text: `Pack Size : ${values.Size}`, style: 'HeaderDetail', border: [false, false, true, false]}
                        ],  
                        [
                            {text: `Quantity : ${values.Quantity} Cartons`, style: 'HeaderDetail',border: [true, false, false, true]}, 
                            {text: `Test Date : ${Moment(values.TimeToTest).format('DD/MM/YYYY')}`, style: 'HeaderDetail',border: [false, false, true, true]}
                        ]
                    ]
                }
            },
              '\n',
            {
                                ...
                                stack:[
                                    {
                                        columns:[
                                            {
                                                text: `${detailById.PHCOAMin+'-'+detailById.PHCOAMax}`, 
                                                style: 'valuess',
                                                width: '*'
                                            }
                                        ]
                                ...
                                stack:[
                                    {
                                        columns:[
                                            {
                                                text: `${values.PH+"/"+values.TempPH+"\u00B0C"}`, 
                                                style: 'valuess',
                                                width: '*'
                                            }
                                        ]
                                ...
                                stack:[
                                    {
                                        columns:[
                                            {
                                                text: `${detailById.SaltCOAMin+'-'+detailById.SaltCOAMax}`, 
                                                style: 'valuess',
                                                width: '*'
                                            }
                                        ]
                                ...
                                stack:[
                                    {
                                        columns:[
                                            {
                                                text: `${detailById.TSSMin+'-'+detailById.TSSMax}`, 
                                                style: 'valuess',
                                                width: '*'
                                            }
                                        ]
                                ...
                                stack:[
                                    {
                                        columns:[
                                            {
                                                text: `${values.Aw+"/"+values.TempAW+"\u00B0C"}`, 
                                                style: 'valuess',
                                                width: '*'
                                            }
                                        ]
                ...
                table: {
                    ...
                    body: [
                        [
                            {text: `Sensory`, style: 'HeaderDetail',border: [true, false, false, false],decoration: 'underline'}, //ซ้าย บน ขวา ล่าง
                            {text: ` `, style: 'HeaderDetail',border: [false, false, true, false]},
                        ],
                        [
                            {text: `Appearance`, style: 'HeaderFoot',border: [true, false, false, false]},
                            {text: `:Clear light brown thin liquid, fishy flavor, first pressing extra virgin`, style: 'HeaderFoot',border: [false, false, true, false]},
                        ],
                        [
                            {text: ``, style: 'HeaderFoot',border: [true, false, false, false]},
                            {text: `No sedimentation`, style: 'HeaderFoot',border: [false, false, true, false]},
                        ],
                        [
                            {text: `Odor`, style: 'HeaderFoot',border: [true, false, false, false]},
                            {text: `:Fresh fish sauce odor`, style: 'HeaderFoot',border: [false, false, true, false]},
                        ],
                        [
                            {text: `Taste`, style: 'HeaderFoot',border: [true, false, false, false]},
                            {text: `:Fresh fish sauce taste`, style: 'HeaderFoot',border: [false, false, true, false]},
                        ],
                        [
                            {text: `Color`, style: 'HeaderFoot',border: [true, false, false, true]},
                            {text: `:Clear rockfish brown thin liquid`, style: 'HeaderFoot',border: [false, false, true, true]},
                        ]
                    ]
                }
            },
        ...
        <Modal
                    ...
                    >
                      <div className="modal-header">
                        <h3 className="modal-title mt-0">SELECR FORM COA
                        </h3>
                        <button
                          type="button"
                          onClick={toggleCOA}
                      ...
                      <div className="col-md-12" style={{display:'flex', justifyContent:'flex-start', alignItems:'center'}}>
                        ...
                        <label
                         ...
                         <Row  className="mb-3" style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                             <img src={`data:image/png;base64,${imgbs64}`} style={{maxWidth:150, maxHeight:100}}/>
                         </Row>
                      ...
                      <ModalFooter>
                          ...
                          <Button color="secondary" onClick={toggleCOA}>Cancel</Button>
                        </ModalFooter>
                    </Modal>   
    )
}
